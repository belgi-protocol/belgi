...
4) Update `tools/_sweep/inputs.py` if the canonical input surface changes, and update `tools/_sweep/managed_surfaces.py` if the managed operational surface inventory changes.
