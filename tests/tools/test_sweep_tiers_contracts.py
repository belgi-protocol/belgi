...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "CS-TIER-004",
            lambda root: replace_text(root, "gates/GATE_R.md", "command_log_mode", "command_log_shape"),
            owner.check_cs_tier_004,
            "gates/GATE_R.md#51-command-matching-rule-used-by-r1r5r6r7r8",
        ),
        (
            "CS-TIER-005",
            lambda root: replace_text(root, "tiers/tier-packs.md", "doc_impact_required", "doc_impact_optional"),
