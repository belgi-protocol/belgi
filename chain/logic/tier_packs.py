...
def load_tier_params(tiers_text: str, tier_id: str) -> TierParamsLoadResult:
    ...
    raw = _parse_tier_params_from_json(tiers_text, tier_id)
...
def parse_tier_params(tiers_text: str, tier_id: str) -> dict[str, Any]:
    """Parse tier parameters from canonical JSON SSOT.

    Canonical runtime owner: tiers/tier-packs.json
    Generated markdown view: tiers/tier-packs.md is not runtime authority.
    """
