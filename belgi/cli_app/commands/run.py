...
def _render_runbook_template(*, run_id: str) -> str:
    ...
    return (
        ...
        "```\n\n"
        "If you run a different tier, keep the same canonical paths and change only the Tolerances `tier_id` / ceilings so the object stays within that selected tier.\n\n"
