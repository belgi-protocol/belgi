...
## [Phase-1] Local CI reproducibility + Portfoly adoption surfaces (2026-02-13)
...
- Deterministic adopter demo proof contract used by Portfoly:
...
- Deterministic sweep/fixture outputs recalibrated through canonical converge (`dev_sync`) after Phase-1 surface changes.

### Notes
- Canonical semantics were preserved across Phase-1 (`schemas/`, `gates/`, `tiers/` meaning unchanged).
